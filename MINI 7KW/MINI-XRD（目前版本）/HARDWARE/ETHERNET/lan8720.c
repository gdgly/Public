...
** 输    入 : 无
** 输    出 : 无
** 返    回 : 001:10M半双工     101:10M全双工      010:100M半双工        110:100M全双工
*************************************************************************************************************
*/
...
/************************************************************************************************************
** 函 数 名 : LAN8720GetLink
** 功能描述 : 获取网线连接状态
** 输    入 : 无
** 输    出 : 无
** 返    回 : 0 未插网线     PHY_Linked_Status 插网线
*************************************************************************************************************
*/
uint8_t LAN8720GetLink(void)
{
